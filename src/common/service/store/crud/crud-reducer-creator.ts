...
// export const crudReducerCreator = (api: IEditableResponseAPI<IApiEntity>) => {
...
//         return {
//           ...state,
//           items: state.items.map(x => (state.editingItem !== null && x.id !== state.editingItem.id ? x : { ...x, ...action.item })),
//         };
//       case 'crud/delete':
